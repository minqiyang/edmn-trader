...
- `src/edmn_trader/scripts/paper_report_pack.py`: importable Stage 10/12/13
  ...
  metadata, and local run-comparison metadata.
...
- `tests/test_paper_report_pack.py`: Stage 10/12/13 offline report-pack coverage
  ...
  manifest/comparison rejection, and CLI output.
